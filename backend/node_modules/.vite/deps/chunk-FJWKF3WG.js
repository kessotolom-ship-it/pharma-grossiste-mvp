  ...
  for (let element of elements2) {
    ...
    while (element.parentElement && element !== doc.body) {
      ...
      if (!hasAncestorAlready) {
        for (const child of element.parentElement.children) if (isValidElement3(id, child, elements2)) callback(child, originalElement);
      }
      element = element.parentElement;
    }
  }
...
function createCompositeStore(props = {}) {
  ...
  const getNextId = (direction = "next", options = {}) => {
    ...
    if (!activeItem) return (_b = findFirstEnabledItem2(items)) == null ? void 0 : _b.id;
    ...
    if (canLoop) return (_d = findFirstEnabledItem2(flipItems2(canWrap && !hasNullItem ? items : getItemsInRow(items, activeItem.rowId), activeId2, hasNullItem), activeId2)) == null ? void 0 : _d.id;
    if (canWrap) {
...
var useTab = createHook(function useTab2({ store, getItem: getItemProp, ...props }) {
  ...
  const panelId = useStoreState(store.panels, (state) => {
    var _a;
    return (_a = state.items.find((item) => item.tabId === id)) == null ? void 0 : _a.id;
  });
...
var useHovercard = createHook(function useHovercard2({ store, modal = false, portal = modal, hideOnEscape = true, hideOnHoverOutside = true, disablePointerEventsOnApproach = !!hideOnHoverOutside, ...props }) {
  ...
  const [nestedHovercards, setNestedHovercards] = (0, import_react46.useState)([]);
...
var useSelect = createHook(function useSelect2({ store, name, form, required, showOnKeyDown = true, moveOnKeyDown = true, toggleOnPress = true, toggleOnClick = toggleOnPress, ...props }) {
  ...
  const [autofill, setAutofill] = (0, import_react57.useState)(false);
  const nativeSelectChangedRef = (0, import_react57.useRef)(false);
  ...
  const values = (0, import_react57.useMemo)(() => {
...
var useSelectHeading = createHook(function useSelectHeading2(props) {
  const [, setHeadingId] = (0, import_react58.useContext)(SelectHeadingContext) || [];
  const id = useId(props.id);
  useSafeLayoutEffect(() => {
    setHeadingId == null ? void 0 : setHeadingId(id);
    return () => setHeadingId == null ? void 0 : setHeadingId(void 0);
...
var useSelectItemCheck = createHook(function useSelectItemCheck2({ store, checked, ...props }) {
  const context = (0, import_react60.useContext)(SelectItemCheckedContext);
  checked = checked ?? context;
  props = useCheckboxCheck({
    ...props,
    checked
...
var TagName77 = "div";
var SelectListContext = (0, import_react61.createContext)(null);
var useSelectList = createHook(function useSelectList2({ store, resetOnEscape = true, hideOnEnter = true, focusOnMove = true, composite, alwaysVisible, ...props }) {
  ...
  const value = useStoreState(store, "value");
  const multiSelectable = Array.isArray(value);
  const [defaultValue2, setDefaultValue] = (0, import_react61.useState)(value);
  const mounted = useStoreState(store, "mounted");
  ...
  const headingContext = (0, import_react61.useContext)(SelectHeadingContext);
  const headingState = (0, import_react61.useState)();
  const [headingId, setHeadingId] = headingContext || headingState;
  const headingContextValue = (0, import_react61.useMemo)(() => [headingId, setHeadingId], [headingId, setHeadingId]);
  const [childStore, setChildStore] = (0, import_react61.useState)(null);
  const setStore = (0, import_react61.useContext)(SelectListContext);
  (0, import_react61.useEffect)(() => {
    if (!setStore) return;
    setStore(store);
...
var useFormControl = createHook(function useFormControl2({ store, name: nameProp, getItem: getItemProp, touchOnBlur = true, ...props }) {
  ...
  const invalid = useStoreState(store, () => !!(store == null ? void 0 : store.getError(name)) && store.getFieldTouched(name));
  props = {
...
var useFormPush = createHook(function useFormPush2({ store, value, name: nameProp, getItem: getItemProp, autoFocusOnClick = true, ...props }) {
  ...
  const name = String(nameProp);
  const [shouldFocus, setShouldFocus] = (0, import_react70.useState)(false);
...
var MenuItemCheckedContext = (0, import_react72.createContext)(void 0);
var MenuListHiddenContext = (0, import_react72.createContext)(false);
...
function useAriaLabelledBy({ store, ...props }) {
  const [id, setId] = (0, import_react73.useState)(void 0);
  const label = props["aria-label"];
  const disclosureElement = useStoreState(store, "disclosureElement");
  const contentElement = useStoreState(store, "contentElement");
...
var useMenu = createHook(function useMenu2({ store, modal: modalProp = false, portal = modalProp, hideOnEscape = true, autoFocusOnShow = true, hideOnHoverOutside, alwaysVisible, ...props }) {
  ...
  props = menuListProps;
  const [initialFocusRef, setInitialFocusRef] = (0, import_react74.useState)();
  ...
  (0, import_react74.useEffect)(() => {
    ...
    setInitialFocusRef((prevInitialFocusRef) => {
      ...
      const ref2 = (0, import_react74.createRef)();
  ...
  const preserveTabOrderAnchor = (0, import_react74.useMemo)(() => {
...
var useMenuItem = createHook(function useMenuItem2({ store, hideOnClick = true, preventScrollOnKeyDown = true, focusOnHover, blurOnHoverEnd, ...props }) {
  ...
  const menuListHidden = (0, import_react79.useContext)(MenuListHiddenContext);
  props = {
...
var useMenuItemCheck = createHook(function useMenuItemCheck2({ store, checked, ...props }) {
  const context = (0, import_react80.useContext)(MenuItemCheckedContext);
  checked = checked ?? context;
  props = useCheckboxCheck({
    ...props,
    checked
...
var useMenuItemRadio = createHook(function useMenuItemRadio2({ store, name, value, checked, onChange: onChangeProp, hideOnClick = false, ...props }) {
  const context = useMenuScopedContext();
  store = store || context;
...
//# sourceMappingURL=chunk-FJWKF3WG.js.map
