...
var ROLE_INJECTION_ZONES = [
  "role.details.before",
  "role.details.after",
  "role.list.before",
  "role.list.after"
];
var POLICY_INJECTION_ZONES = [
...
var STORE_CREDIT_ACCOUNT_INJECTION_ZONES = [
...
var GIFT_CARD_PRODUCT_INJECTION_ZONES = [
...
function isValidInjectionZone(zone) {
  ...
  if (INJECTION_ZONES.includes(zone)) return true;
...
//# sourceMappingURL=chunk-WF4S7KED.js.map
