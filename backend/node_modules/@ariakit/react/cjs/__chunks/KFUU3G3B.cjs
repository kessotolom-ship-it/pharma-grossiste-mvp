...
function getFlipMiddleware(props) {
  ...
  _JBOLBTVUcjs.invariant.call(void 0, !fallbackPlacements || fallbackPlacements.every(isValidPlacement), process.env.NODE_ENV !== "production" && "`flip` expects a spaced-delimited list of placements");
  return flip2({
...
var usePopover = _JBOLBTVUcjs.createHook.call(void 0, function usePopover2({ store, modal = false, portal = modal, preserveTabOrder = true, autoFocusOnShow = true, wrapperProps, fixed = false, flip: flip3 = true, shift: shift3 = 0, slide = true, overlap = false, sameWidth = false, fitViewport = false, gutter, arrowPadding = 4, overflowPadding = 8, getAnchorRect, updatePosition, ...props }) {
  const context = _KDVG735Hcjs.usePopoverProviderContext.call(void 0, );
  store = store || context;
  _JBOLBTVUcjs.invariant.call(void 0, store, process.env.NODE_ENV !== "production" && "Popover must receive a `store` prop or be wrapped in a PopoverProvider component.");
  const arrowElement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "arrowElement");
  const anchorElement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "anchorElement");
  const disclosureElement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "disclosureElement");
  const popoverElement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "popoverElement");
  const contentElement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "contentElement");
  const placement = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "placement");
  const mounted = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "mounted");
  const rendered = _FHPV2Q7Ccjs.useStoreState.call(void 0, store, "rendered");
  ...
  const getAnchorRectProp = _JBOLBTVUcjs.useEvent.call(void 0, getAnchorRect);
  const updatePositionProp = _JBOLBTVUcjs.useEvent.call(void 0, updatePosition);
  ...
  props = _JBOLBTVUcjs.useWrapElement.call(void 0, props, (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", {
    ...wrapperProps,
    style: {
      position,
      top: 0,
  ...
  props = _QJQWEU4Qcjs.useDialog.call(void 0, {
    store,
    modal,
    portal,
    preserveTabOrder,
...
var Popover = _QJQWEU4Qcjs.createDialogComponent.call(void 0, _JBOLBTVUcjs.forwardRef.call(void 0, function Popover2(props) {
  return _JBOLBTVUcjs.createElement.call(void 0, TagName, usePopover(props));
}), _KDVG735Hcjs.usePopoverProviderContext);

// ../ariakit-components/dist/popover/popover-store.js
function createPopoverStore({ popover: otherPopover, ...props } = {}) {
  const store = _FHPV2Q7Ccjs.mergeStore.call(void 0, props.store, _FHPV2Q7Ccjs.omit.call(void 0, otherPopover, [
    "arrowElement",
    "anchorElement",
    "contentElement",
    "popoverElement",
  ...
  const dialog = _QJQWEU4Qcjs.createDialogStore.call(void 0, {
    ...props,
    store
  });
  const placement = _JBOLBTVUcjs.defaultValue.call(void 0, props.placement, syncState == null ? void 0 : syncState.placement, "bottom");
  const popover = _FHPV2Q7Ccjs.createStore.call(void 0, {
    ...dialog.getState(),
    placement,
    currentPlacement: placement,
    anchorElement: _JBOLBTVUcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.anchorElement, null),
    popoverElement: _JBOLBTVUcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.popoverElement, null),
    arrowElement: _JBOLBTVUcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.arrowElement, null),
...
function usePopoverStoreProps(store, update, props) {
  _JBOLBTVUcjs.useUpdateEffect.call(void 0, update, [props.popover]);
  _FHPV2Q7Ccjs.useStoreProps.call(void 0, store, props, "placement");
  return _QJQWEU4Qcjs.useDialogStoreProps.call(void 0, store, update, props);
}
function usePopoverStore(props = {}) {
  const [store, update] = _FHPV2Q7Ccjs.useStore.call(void 0, createPopoverStore, props);
