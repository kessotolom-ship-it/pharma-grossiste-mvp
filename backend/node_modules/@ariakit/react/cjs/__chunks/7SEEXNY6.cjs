...
var TagName = "h1";
var useHeading = _JBOLBTVUcjs.createHook.call(void 0, function useHeading2(props) {
  const ref = _react.useRef.call(void 0, null);
  const level = _react.useContext.call(void 0, _DWSXHZYMcjs.HeadingContext) || 1;
  const Element = `h${level}`;
  const tagName = _JBOLBTVUcjs.useTagName.call(void 0, ref, Element);
...
var Heading = _JBOLBTVUcjs.forwardRef.call(void 0, function Heading2(props) {
  return _JBOLBTVUcjs.createElement.call(void 0, TagName, useHeading(props));
});
