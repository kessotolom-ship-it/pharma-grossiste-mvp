...
function onGlobalMouseDown(event) {
  ...
  if (_JBOLBTVUcjs.isElement.call(void 0, target) && !target.hasAttribute("data-focus-visible")) isKeyboardModality = false;
}
...
var useFocusable = _JBOLBTVUcjs.createHook.call(void 0, function useFocusable2({ focusable = true, accessibleWhenDisabled, autoFocus, onFocusVisible, ...props }) {
  const ref = _react.useRef.call(void 0, null);
  const [parentAccessibleWhenDisabled, metadataProps] = _JBOLBTVUcjs.useMetadataProps.call(void 0, props, accessibleWhenDisabledSymbol, accessibleWhenDisabled);
  ...
  _react.useEffect.call(void 0, () => {
    ...
    _JBOLBTVUcjs.addGlobalEventListener.call(void 0, "mousedown", onGlobalMouseDown, true);
    _JBOLBTVUcjs.addGlobalEventListener.call(void 0, "keydown", onGlobalKeyDown, true);
    hasInstalledGlobalEventListeners = true;
  }, [focusable]);
  const disabled = focusable && _JBOLBTVUcjs.disabledFromProps.call(void 0, props);
  ...
  const cleanupFocusVisible = _JBOLBTVUcjs.useEvent.call(void 0, (element) => {
    var _a;
  ...
  _react.useEffect.call(void 0, () => {
    ...
    const observer = new IntersectionObserver(() => {
      if (!_JBOLBTVUcjs.isFocusable.call(void 0, element)) {
        focusVisibleRef.current = false;
  ...
  const handleFocusVisible = (event, currentTarget) => {
    ...
    if (isNativeSubmitControl(element)) {
      ...
      if (typeof IntersectionObserver !== "undefined") {
        const observer = new IntersectionObserver(() => {
          if (_JBOLBTVUcjs.isFocusable.call(void 0, element)) return;
  ...
  const onKeyDownCapture = _JBOLBTVUcjs.useEvent.call(void 0, (event) => {
    ...
    _JBOLBTVUcjs.queueBeforeEvent.call(void 0, element, "focusout", applyFocusVisible);
  });
  ...
  const onFocusCapture = _JBOLBTVUcjs.useEvent.call(void 0, (event) => {
    ...
    const element = event.currentTarget;
    const applyFocusVisible = () => handleFocusVisible(event, element);
    if (isKeyboardModality || isAlwaysFocusVisible(event.target)) _JBOLBTVUcjs.queueBeforeEvent.call(void 0, event.target, "focusout", applyFocusVisible);
  ...
  const autoFocusRef = _JBOLBTVUcjs.useEvent.call(void 0, (element) => {
    if (!focusable) return;
    if (!autoFocus) return;
    if (!element) return;
  ...
  const tagName = _JBOLBTVUcjs.useTagName.call(void 0, ref);
  ...
  props = {
    ...
    ...props,
    ...metadataProps,
    ref: _JBOLBTVUcjs.useMergeRefs.call(void 0, ref, autoFocusRef, props.ref),
    style,
...
var Focusable = _JBOLBTVUcjs.forwardRef.call(void 0, function Focusable2(props) {
  return _JBOLBTVUcjs.createElement.call(void 0, TagName, useFocusable(props));
});
