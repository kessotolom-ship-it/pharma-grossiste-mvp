...
import { CreateAccountHolderDTO, CreateCaptureDTO, CreatePaymentCollectionDTO, CreatePaymentMethodDTO, CreatePaymentSessionDTO, CreateRefundDTO, CreateRefundReasonDTO, DeletePaymentMethodDTO, PaymentCollectionUpdatableFields, ProviderWebhookPayload, UpdateAccountHolderDTO, UpdatePaymentDTO, UpdatePaymentSessionDTO, UpdateRefundReasonDTO, UpsertPaymentCollectionDTO } from "./mutations";
...
export interface IPaymentModuleService extends IModuleService {
     ...
     * ])
     */
    deletePaymentMethods(data: DeletePaymentMethodDTO[], sharedContext?: Context): Promise<void>;
    /**
