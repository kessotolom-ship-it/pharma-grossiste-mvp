 ...
 * @since 2.16.0
 */
export interface DeletePaymentMethodInput extends Omit<PaymentProviderInput, "data"> {
    /**
...
export interface IPaymentProvider {
    ...
    *     const paymentMethodId = data.id
     ...
     * }
     */
    deletePaymentMethod?(data: DeletePaymentMethodInput): Promise<DeletePaymentMethodOutput>;
