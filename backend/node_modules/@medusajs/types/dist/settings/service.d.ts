...
import { ViewConfigurationDTO, UserPreferenceDTO, PropertyLabelDTO, FilterableViewConfigurationProps, FilterableUserPreferenceProps, PropertyLabelFilterableFields } from "./common";
import { CreateViewConfigurationDTO, UpdateViewConfigurationDTO, CreatePropertyLabelDTO, UpdatePropertyLabelDTO, UpsertPropertyLabelDTO } from "./mutations";
export interface ISettingsModuleService extends IModuleService {
    ...
    listAndCountUserPreferences(filters?: FilterableUserPreferenceProps, config?: FindConfig<UserPreferenceDTO>, sharedContext?: Context): Promise<[UserPreferenceDTO[], number]>;
    createUserPreferences(data: {
        user_id: string;
        key: string;
        value: any;
    }, sharedContext?: Context): Promise<UserPreferenceDTO>;
    createUserPreferences(data: {
        user_id: string;
        key: string;
        value: any;
    ...
    retrievePropertyLabel(id: string, config?: FindConfig<PropertyLabelDTO>, sharedContext?: Context): Promise<PropertyLabelDTO>;
    listPropertyLabels(filters?: PropertyLabelFilterableFields, config?: FindConfig<PropertyLabelDTO>, sharedContext?: Context): Promise<PropertyLabelDTO[]>;
    listAndCountPropertyLabels(filters?: PropertyLabelFilterableFields, config?: FindConfig<PropertyLabelDTO>, sharedContext?: Context): Promise<[PropertyLabelDTO[], number]>;
    /**
     * Create a property label.
     */
    createPropertyLabels(data: CreatePropertyLabelDTO, sharedContext?: Context): Promise<PropertyLabelDTO>;
    /**
     ...
     */
    updatePropertyLabels(data: UpdatePropertyLabelDTO[], sharedContext?: Context): Promise<PropertyLabelDTO[]>;
    /**
     * Update property labels by selector.
     */
    updatePropertyLabels(options: {
        selector: PropertyLabelFilterableFields;
        data: UpdatePropertyLabelDTO;
    }, sharedContext?: Context): Promise<PropertyLabelDTO[]>;
    /**
     * Retrieve a property label by entity and property.
     */
    retrievePropertyLabel({ entity, property }: {
        entity: string;
        property?: string;
    }, sharedContext?: Context): Promise<PropertyLabelDTO>;
    /**
     ...
     */
    upsertPropertyLabels(data: UpsertPropertyLabelDTO[], sharedContext?: Context): Promise<PropertyLabelDTO[]>;
    deletePropertyLabels(ids: string | string[], sharedContext?: Context): Promise<void>;
    /**
     ...
     */
    generateEntityColumns(entityKey: string, sharedContext?: Context): Promise<AdminColumn[] | null>;
    /**
