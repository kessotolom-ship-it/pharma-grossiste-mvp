...
import { AuthenticationInput, AuthenticationResponse, AuthMfaChallengeDTO, AuthMfaDTO, AuthMfaSelector, AuthMfaStartResponse, AuthIdentityDTO, UseAuthMfaRecoveryCodeDTO, CreateAuthIdentityDTO, CreateAuthMfaChallengeDTO, AuthMfaStartDTO, CreateProviderIdentityDTO, DisableAuthMfaDTO, FilterableAuthIdentityProps, FilterableAuthMfaProps, FilterableProviderIdentityProps, GenerateAuthMfaRecoveryCodesDTO, GenerateAuthMfaRecoveryCodesResponse, ProviderIdentityDTO, UpdateAuthIdentityDTO, UpdateProviderIdentityDTO, VerifyAuthMfaChallengeDTO, AuthMfaVerifyDTO, ConfirmAuthVerificationDTO, ConfirmAuthVerificationResponse, ConsumePasswordResetTokenDTO, ConsumePasswordResetTokenResponse, CreatePasswordResetTokenDTO, CreatePasswordResetTokenResponse, RequestAuthVerificationDTO, RequestAuthVerificationResponse, AuthVerificationDTO, FilterableAuthVerificationProps } from "./common";
/**
...
export interface IAuthModuleService extends IModuleService {
     ...
     */
    createPasswordResetToken(data: CreatePasswordResetTokenDTO, sharedContext?: Context): Promise<CreatePasswordResetTokenResponse>;
    /**
     ...
     */
    consumePasswordResetToken(data: ConsumePasswordResetTokenDTO, sharedContext?: Context): Promise<ConsumePasswordResetTokenResponse>;
    /**
     ...
     */
    validateAuthIdentity(id: string, provider: string, config?: FindConfig<AuthIdentityDTO>, sharedContext?: Context): Promise<AuthenticationResponse>;
    /**
     ...
     * ```
     */
    startAuthMfa(data: AuthMfaStartDTO, sharedContext?: Context): Promise<AuthMfaStartResponse>;
    /**
     ...
     * ```
     */
    verifyAuthMfa(data: AuthMfaVerifyDTO, sharedContext?: Context): Promise<AuthMfaDTO>;
    /**
     ...
     * ```
     */
    createAuthMfaChallenge(data: CreateAuthMfaChallengeDTO, sharedContext?: Context): Promise<AuthMfaChallengeDTO>;
    /**
     ...
     * ```
     */
    verifyAuthMfaChallenge(data: VerifyAuthMfaChallengeDTO, sharedContext?: Context): Promise<AuthMfaChallengeDTO>;
    /**
     ...
     * ```
     */
    disableAuthMfa(data: DisableAuthMfaDTO, sharedContext?: Context): Promise<AuthMfaDTO>;
    /**
     ...
     * ```
     */
    retrieveAuthMfa(selector: string | AuthMfaSelector, config?: FindConfig<AuthMfaDTO>, sharedContext?: Context): Promise<AuthMfaDTO>;
    /**
     ...
     * ```
     */
    listAuthMfa(filters?: FilterableAuthMfaProps, config?: FindConfig<AuthMfaDTO>, sharedContext?: Context): Promise<AuthMfaDTO[]>;
    /**
     ...
     * ```
     */
    generateAuthMfaRecoveryCodes(data: GenerateAuthMfaRecoveryCodesDTO, sharedContext?: Context): Promise<GenerateAuthMfaRecoveryCodesResponse>;
    /**
     ...
     * ```
     */
    useAuthMfaRecoveryCode(data: UseAuthMfaRecoveryCodeDTO, sharedContext?: Context): Promise<void>;
    /**
     ...
     */
    requestAuthVerification(data: RequestAuthVerificationDTO, sharedContext?: Context): Promise<RequestAuthVerificationResponse>;
    /**
     ...
     */
    confirmAuthVerification(data: ConfirmAuthVerificationDTO, sharedContext?: Context): Promise<ConfirmAuthVerificationResponse>;
    /**
     ...
     */
    retrieveAuthVerification(id: string, config?: FindConfig<AuthVerificationDTO>, sharedContext?: Context): Promise<AuthVerificationDTO>;
    /**
     ...
     */
    listAuthVerifications(filters: FilterableAuthVerificationProps, config?: FindConfig<AuthVerificationDTO>, sharedContext?: Context): Promise<AuthVerificationDTO[]>;
    /**
     ...
     * @returns {Promise<AuthVerificationDTO[]>} The list of verifications.
     */
    listAndCountAuthVerifications(filters: FilterableAuthVerificationProps, config?: FindConfig<AuthVerificationDTO>, sharedContext?: Context): Promise<[AuthVerificationDTO[], number]>;
    /**
