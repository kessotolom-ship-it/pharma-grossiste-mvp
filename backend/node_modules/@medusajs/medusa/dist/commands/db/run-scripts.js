...
async function loadResources(plugins, logger, container) {
    /**
    ...
    const workflowsSourcePaths = plugins.map((plugin) => (0, path_1.join)(plugin.resolve, "workflows"));
    await new workflows_1.WorkflowLoader(workflowsSourcePaths, container).load();
    return {
