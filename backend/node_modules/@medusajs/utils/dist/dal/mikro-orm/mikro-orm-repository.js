...
const prune_find_options_against_metadata_1 = require("./prune-find-options-against-metadata");
...
function mikroOrmBaseRepositoryFactory(entity) {
    ...
    class MikroOrmAbstractBaseRepository_ extends MikroOrmBaseRepository {
        ...
        async find(options = { where: {} }, context) {
            ...
            (0, prune_find_options_against_metadata_1.pruneFindOptionsAgainstMetadata)(manager.getDriver().getMetadata().get(this.entity.name), findOptions_.options);
