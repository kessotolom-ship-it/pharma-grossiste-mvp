...
const filter_items_by_shipping_profile_1 = require("../../cart/utils/filter-items-by-shipping-profile");
...
exports.calculateShippingOptionsPricesWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.calculateShippingOptionsPricesWorkflowId, (input) => {
    ...
    const data = (0, workflows_sdk_1.transform)({
        ...
        return shippingOptions.map((shippingOption) => ({
            ...
            context: {
                ...cart,
                items: (0, filter_items_by_shipping_profile_1.filterCartItemsByShippingProfile)(cart.items, shippingOption.shipping_profile_id),
