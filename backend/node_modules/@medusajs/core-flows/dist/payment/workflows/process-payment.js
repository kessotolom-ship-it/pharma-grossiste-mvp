...
exports.processPaymentWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.processPaymentWorkflowId, (input) => {
    ...
    const cartId = (0, workflows_sdk_1.transform)({ cartPaymentCollection, input }, ({ cartPaymentCollection, input }) => {
    ...
    (0, workflows_sdk_1.when)({ input, paymentData }, ({ input, paymentData }) => {
        return (!!input.data?.session_id &&
            input.action === utils_1.PaymentActions.SUCCESSFUL &&
    ...
    (0, workflows_sdk_1.when)({ input, cartPaymentCollection, order }, ({ input, cartPaymentCollection, order }) => {
        return (!!input.data?.session_id &&
