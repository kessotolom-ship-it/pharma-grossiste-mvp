 ...
 * })
 */
exports.confirmOrderEditRequestValidationStep = (0, workflows_sdk_1.createStep)("confirm-order-edit-request-validation", async function ({ order, orderChange, }) {
    (0, order_validation_1.throwIfIsCancelled)(order, "Order");
    (0, order_validation_1.throwIfOrderChangeIsNotActive)({ orderChange });
});
const orderFields = (0, utils_1.deduplicate)([
