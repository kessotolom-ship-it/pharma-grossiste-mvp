...
exports.orderExchangeRequestItemReturnWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.orderExchangeRequestItemReturnWorkflowId, function (input) {
    ...
    (0, workflows_sdk_1.when)({ createdReturn }, ({ createdReturn }) => {
        ...
        const orderChangeUpdateInput = (0, workflows_sdk_1.transform)({ orderChange, createdReturn }, ({ orderChange, createdReturn }) => {
            return [{
                    id: orderChange.id,
                    return_id: createdReturn?.[0]?.id,
                }];
        });
        (0, update_order_changes_1.updateOrderChangesStep)(orderChangeUpdateInput);
    });
    ...
    (0, workflows_sdk_1.when)({ orderExchange }, ({ orderExchange }) => {
        ...
        const updateOrderExchangesInput = (0, workflows_sdk_1.transform)({ orderExchange, createdReturn }, ({ orderExchange, createdReturn }) => {
            return [
                {
                    id: orderExchange.id,
        ...
        (0, update_order_exchanges_1.updateOrderExchangesStep)(updateOrderExchangesInput);
    });
