...
export declare const createOrderWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<CreateOrderWorkflowInput, import("@medusajs/framework/types").OrderDTO, [import("@medusajs/framework/workflows-sdk").Hook<"orderCreated", {
    ...
    region: any;
    customerData: import("../../cart/steps/find-or-create-customer").FindOrCreateCustomerOutputStepOutput & import("@medusajs/framework/workflows-sdk").WorkflowDataProperties<import("../../cart/steps/find-or-create-customer").FindOrCreateCustomerOutputStepOutput> & {
        config(config: {
            name?: string;
