...
const variantFields = (0, utils_1.deduplicate)([
...
exports.createOrderWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createOrdersWorkflowId, (input) => {
     ...
     */
    const customerId = (0, workflows_sdk_1.transform)({ customerData }, (data) => data.customerData.customer?.id);
    const customerForPricing = (0, workflows_sdk_1.when)("fetch-customer-groups", { customerId }, ({ customerId }) => !!customerId).then(() => {
        const { data: customer } = (0, common_1.useQueryGraphStep)({
            entity: "customer",
            fields: ["id", "groups.id"],
