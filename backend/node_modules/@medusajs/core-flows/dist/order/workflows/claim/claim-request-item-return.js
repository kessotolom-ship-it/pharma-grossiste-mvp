 ...
 * })
 */
exports.orderClaimRequestItemReturnValidationStep = (0, workflows_sdk_1.createStep)("order-claim-request-item-return-validation", async function ({ order, orderChange, orderReturn, orderClaim, items, }) {
...
exports.orderClaimRequestItemReturnWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.orderClaimRequestItemReturnWorkflowId, function (input) {
    ...
    (0, workflows_sdk_1.when)({ createdReturn }, ({ createdReturn }) => {
        ...
        const updateOrderChangeInput = (0, workflows_sdk_1.transform)({ orderChange, createdReturn }, ({ orderChange, createdReturn }) => {
            return [{
                    id: orderChange.id,
                    return_id: createdReturn?.[0]?.id,
                }];
        });
        (0, update_order_changes_1.updateOrderChangesStep)(updateOrderChangeInput);
    });
    ...
    (0, workflows_sdk_1.when)({ orderClaim }, ({ orderClaim }) => {
        ...
        const updateOrderClaimsInput = (0, workflows_sdk_1.transform)({ orderClaim, createdReturn }, ({ orderClaim, createdReturn }) => {
            return [{
                    id: orderClaim.id,
                    return: createdReturn?.[0]?.id,
                }];
        });
        (0, update_order_claims_1.updateOrderClaimsStep)(updateOrderClaimsInput);
    });
