 ...
 * })
 */
exports.orderClaimAddNewItemValidationStep = (0, workflows_sdk_1.createStep)("order-claim-add-new-item-validation", async function ({ order, orderChange, orderClaim, }) {
