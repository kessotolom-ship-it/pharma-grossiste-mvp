 ...
 */
export declare const upsertTaxLinesWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpsertTaxLinesWorkflowInput, undefined, [import("@medusajs/framework/workflows-sdk").Hook<"setTaxLineContext", {
    cart: any;
    items: CartLineItemDTO[];
    shipping_methods: CartShippingMethodDTO[];
