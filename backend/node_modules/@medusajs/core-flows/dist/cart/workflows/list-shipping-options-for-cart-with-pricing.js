...
const filter_items_by_shipping_profile_1 = require("../utils/filter-items-by-shipping-profile");
...
exports.listShippingOptionsForCartWithPricingWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.listShippingOptionsForCartWithPricingWorkflowId, (input) => {
    ...
    const calculateShippingOptionsPricesData = (0, workflows_sdk_1.transform)({
        ...
        return shippingOptionsCalculated.map((so) => ({
            ...
            context: {
                ...cart,
                items: (0, filter_items_by_shipping_profile_1.filterCartItemsByShippingProfile)(cart.items, so.shipping_profile_id),
    ...
    return new workflows_sdk_1.WorkflowResponse(translatedShippingOptions, {
