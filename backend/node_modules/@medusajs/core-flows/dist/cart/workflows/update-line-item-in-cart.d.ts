import { AdditionalData, CartDTO, CustomerDTO, RegionDTO, UpdateLineItemInCartWorkflowInputDTO } from "@medusajs/framework/types";
 ...
 */
export declare const findLineItemToUpdateStep: import("@medusajs/framework/workflows-sdk").StepFunction<FindLineItemToUpdateStepInput, {
    item: import("@medusajs/framework/types").CartLineItemDTO;
 ...
 */
export declare const prepareLineItemUpdateStep: import("@medusajs/framework/workflows-sdk").StepFunction<PrepareLineItemUpdateStepInput, {
    data: {
        unit_price: string | number | import("@medusajs/framework/types").BigNumberRawValue | BigNumber | import("@medusajs/framework/types").IBigNumber;
        is_custom_price: boolean;
        is_tax_inclusive: any;
        id?: string | undefined;
        title?: string | undefined;
        quantity?: import("@medusajs/framework/types").BigNumberInput | undefined;
        metadata?: (Record<string, unknown> | null) | undefined;
        tax_lines?: import("@medusajs/framework/types").UpdateTaxLineDTO[] | import("@medusajs/framework/types").CreateTaxLineDTO[] | undefined;
        adjustments?: import("@medusajs/framework/types").UpdateAdjustmentDTO[] | import("@medusajs/framework/types").CreateAdjustmentDTO[] | undefined;
        ...
        product_subtitle?: string | undefined;
        product_type?: string | undefined;
        product_type_id?: string | undefined;
        product_collection?: string | undefined;
        product_handle?: string | undefined;
        variant_sku?: string | undefined;
        variant_barcode?: string | undefined;
        variant_title?: string | undefined;
        variant_option_values?: Record<string, unknown> | undefined;
        is_discountable?: boolean | undefined;
        compare_at_unit_price?: import("@medusajs/framework/types").BigNumberInput | undefined;
    };
    selector: {
        id: string;
    };
