 ...
 */
export declare const updateCartPromotionsWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateCartPromotionsWorkflowInput, {
    skipped_promo_codes: {
        code: string;
        reason: "promotion_limit_exceeded" | "campaign_budget_exceeded";
    }[];
}, [import("@medusajs/framework/workflows-sdk").Hook<"validate", {
