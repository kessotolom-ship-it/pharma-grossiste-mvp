...
exports.updateCartWorkflow = exports.updateCartWorkflowId = exports.prepareCartToUpdateStep = void 0;
 ...
 */
exports.prepareCartToUpdateStep = (0, workflows_sdk_1.createStep)("prepare-cart-to-update", async (data) => {
...
exports.updateCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    const cartInput = (0, exports.prepareCartToUpdateStep)({
        input,
        region,
        customer,
        salesChannel,
    ...
    */
    ...
    const refreshCartItemsInput = (0, workflows_sdk_1.transform)({ cartInput, input, newRegion, newLocaleCode }, ({ cartInput, input, newRegion, newLocaleCode }) => {
        return {
