...
exports.upsertTaxLinesWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.upsertTaxLinesWorkflowId, (input) => {
    ...
    const setTaxLineContext = (0, workflows_sdk_1.createHook)("setTaxLineContext", {
        cart,
        items: input.items,
        shipping_methods: input.shipping_methods,
    }, {
        resultValidator: schemas_1.taxLineContextResult,
    });
    const setTaxLineContextResult = setTaxLineContext.getResult();
    const taxLineItems = (0, get_item_tax_lines_1.getItemTaxLinesStep)((0, workflows_sdk_1.transform)({ input, cart, setTaxLineContextResult }, (data) => ({
