...
exports.createCartWorkflow = exports.createCartWorkflowId = exports.prepareCartToCreateStep = void 0;
 ...
 * provided.
 */
exports.prepareCartToCreateStep = (0, workflows_sdk_1.createStep)("prepare-cart-to-create", async (data) => {
    if (!data.region) {
    ...
    return new workflows_sdk_1.StepResponse(data_);
});
...
exports.createCartWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createCartWorkflowId, (input) => {
    ...
    const getVariantsAndItemsWithPricesInput = (0, workflows_sdk_1.transform)({
        input,
        region,
        customerData,
        setPricingContextResult,
        variantIds,
        productVariantsFields: fields_1.productVariantsFields,
        requiredVariantFieldsForInventoryConfirmation: prepare_confirm_inventory_input_1.requiredVariantFieldsForInventoryConfirmation,
    }, (data) => {
        return {
            cart: {
    ...
    const cartInput = (0, exports.prepareCartToCreateStep)({
        input,
        region,
        customerData,
        salesChannel,
