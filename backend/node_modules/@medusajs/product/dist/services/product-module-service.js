...
class ProductModuleService extends (0, utils_1.MedusaService)({
    ...
    async updateVariants_(data, sharedContext = {}) {
        ...
        if (hasOptions) {
            ...
            productVariantsWithOptions = ProductModuleService.assignOptionsToVariants(variantsWithProductId, productOptions);
