...
export declare class PaymentCollection {
     ...
     */
    createPaymentSession(id: string, body: HttpTypes.AdminInitializePaymentSession, query?: SelectParams, headers?: ClientHeaders): Promise<HttpTypes.AdminPaymentCollectionResponse>;
}
