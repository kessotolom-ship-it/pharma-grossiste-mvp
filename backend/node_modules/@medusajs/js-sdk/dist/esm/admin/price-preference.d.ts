...
export declare class PricePreference {
     ...
     */
    retrieve(id: string, query?: HttpTypes.AdminGetPricePreferenceParams, headers?: ClientHeaders): Promise<HttpTypes.AdminPricePreferenceResponse>;
    /**
     ...
     * })
     */
    create(body: HttpTypes.AdminCreatePricePreference, query?: HttpTypes.AdminGetPricePreferenceParams, headers?: ClientHeaders): Promise<HttpTypes.AdminPricePreferenceResponse>;
    /**
     ...
     * })
     */
    update(id: string, body: HttpTypes.AdminUpdatePricePreference, query?: HttpTypes.AdminGetPricePreferenceParams, headers?: ClientHeaders): Promise<HttpTypes.AdminPricePreferenceResponse>;
    /**
