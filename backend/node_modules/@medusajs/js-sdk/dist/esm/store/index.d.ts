...
export declare class Store {
    ...
    cart: {
         ...
         * @since 2.13.7
         */
        addPromotions: (cartId: string, body: HttpTypes.StoreCartAddPromotion, query?: SelectParams, headers?: ClientHeaders) => Promise<HttpTypes.StoreCartResponse>;
        /**
         ...
         * @since 2.13.7
         */
        removePromotions: (cartId: string, body: HttpTypes.StoreCartRemovePromotion, query?: SelectParams, headers?: ClientHeaders) => Promise<HttpTypes.StoreCartResponse>;
        /**
