 ...
 */
export type AuthLoginResponse = string | AuthRedirectResponse | AuthMfaRequiredResponse | AuthVerificationRequiredResponse;
/**
 * Response returned from an authentication callback.
 */
export type AuthCallbackResponse = string | AuthMfaRequiredResponse | AuthVerificationRequiredResponse;
export type AuthRefreshResponse = {
    token: string;
} | AuthMfaRequiredResponse | AuthVerificationRequiredResponse;
/**
...
export declare class Auth {
    ...
    mfa: {
         ...
         */
        list: (headers?: ClientHeaders) => Promise<AuthMfaListResponse>;
        /**
         ...
         */
        start: (body: AuthMfaStartPayload, headers?: ClientHeaders) => Promise<AuthMfaSetupResponse>;
        /**
         ...
         * })
         */
        verify: (id: string, body: AuthMfaVerifyPayload, headers?: ClientHeaders) => Promise<AuthMfaFactorResponse>;
        /**
         ...
         */
        disable: (id: string, body?: AuthMfaDisablePayload, headers?: ClientHeaders) => Promise<AuthMfaFactorResponse>;
        /**
         ...
         */
        generateRecoveryCodes: (body?: AuthMfaGenerateRecoveryCodesPayload, headers?: ClientHeaders) => Promise<AuthMfaRecoveryCodesResponse>;
        /**
         ...
         * }
         */
        verifyChallenge: (id: string, body: AuthMfaVerifyChallengePayload, headers?: ClientHeaders) => Promise<string>;
    };
    /**
    ...
    verification: {
         ...
         * @tags auth
         */
        request: (body: AuthVerificationRequestPayload, headers?: ClientHeaders) => Promise<AuthVerificationRequestResponse>;
        /**
         ...
         * @tags auth
         */
        confirm: (body: AuthVerificationConfirmPayload, headers?: ClientHeaders) => Promise<AuthVerificationConfirmResponse>;
    };
    /**
     ...
     * })
     */
    register: (actor: string, method: string, payload: HttpTypes.AdminSignUpWithEmailPassword | Record<string, unknown>) => Promise<AuthRegisterResponse>;
    /**
     ...
     */
    login: (actor: string, method: string, payload: HttpTypes.AdminSignInWithEmailPassword | Record<string, unknown>) => Promise<AuthLoginResponse>;
    /**
     ...
     */
    callback: (actor: string, method: string, query?: Record<string, unknown>) => Promise<AuthCallbackResponse>;
    /**
     ...
     * const { customer } = await sdk.store.customer.retrieve()
     */
    refresh: (headers?: ClientHeaders) => Promise<AuthRefreshResponse>;
    /**
