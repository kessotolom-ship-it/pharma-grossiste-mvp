import { CreateOrderLineItemAdjustmentDTO, CreateOrderShippingMethodAdjustmentDTO, OrderChangeActionDTO } from "@medusajs/framework/types";
...
export declare function applyChangesToOrder(orders: any[], actionsMap: Record<string, any[]>, options?: {
    ...
    shippingMethodAdjustmentsToCreate: CreateOrderShippingMethodAdjustmentDTO[];
    itemsToUpsert: {
        id: string;
        version: number;
