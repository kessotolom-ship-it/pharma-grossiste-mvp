...
calculate_order_change_1.OrderChangeProcessing.registerActionType(utils_1.ChangeActionType.ITEM_UPDATE, {
    operation({ action, currentOrder, options }) {
        ...
        if ((0, utils_1.isDefined)(action.details.metadata)) {
            ...
            if (isUnset) {
                ...
                existing.detail.metadata = (0, utils_1.mergeMetadata)(existing.detail.metadata ?? existing.metadata ?? {}, action.details.metadata);
                existing.metadata = (0, utils_1.mergeMetadata)(existing.metadata ?? {}, action.details.metadata);
            }
        }
