...
declare abstract class StripeBase extends AbstractPaymentProvider<StripeOptions> {
    ...
    protected static hasWarnedMissingWebhookSecret: boolean;
    ...
    deletePaymentMethod({ context, data, }: DeletePaymentMethodInput): Promise<DeletePaymentMethodOutput>;
    private getStatus;
