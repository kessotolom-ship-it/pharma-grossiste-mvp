...
class StripeBase extends utils_1.AbstractPaymentProvider {
    ...
    async deletePaymentMethod({ context, data, }) {
        const paymentMethodId = data?.id;
        if (!paymentMethodId) {
            throw this.buildError("Payment method ID not set while deleting a payment method", new Error("Missing payment method ID"));
        }
...
StripeBase.hasWarnedMissingWebhookSecret = false;
