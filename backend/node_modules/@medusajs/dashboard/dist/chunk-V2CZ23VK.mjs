...
var SalesChannelsCell = ({
  ...
  if (validChannels.length > 2) {
    return /* @__PURE__ */ jsxs("div", { className: "flex h-full w-full items-center gap-x-1 overflow-hidden", children: [
      /* @__PURE__ */ jsx3("span", { className: "truncate", children: validChannels.slice(0, 2).map((sc) => sc.name).join(", ") }),
      /* @__PURE__ */ jsx3(
        Tooltip,
        {
          content: /* @__PURE__ */ jsx3("ul", { children: validChannels.slice(2).map((sc) => /* @__PURE__ */ jsx3("li", { children: sc.name }, sc.id)) }),
  ...
  return /* @__PURE__ */ jsx3("div", { className: "flex h-full w-full max-w-[250px] items-center overflow-hidden", children: /* @__PURE__ */ jsx3("span", { title: channels, className: "truncate", children: channels }) });
};
