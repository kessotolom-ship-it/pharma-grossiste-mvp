 ...
 * the describe text.
 */
function addLintOptions(builder, commandLabel) {
    return builder
        .option("lint", {
        type: "boolean",
...
function buildLocalCommands(cli, isLocalProject) {
    ...
    cli
        ...
        builder: (_) => addLintOptions(_.option("types", {
            type: "boolean",
            default: true,
        ...
        builder: (_) => _.positional("paths", {
            type: "string",
            array: true,
            describe: "Files or directories to lint. Defaults to the whole project.",
        })
            .option("fix", {
            type: "boolean",
            default: false,
        ...
        handler: handlerP(getCommandHandler(`lint`, async (args, cmd) => {
            process.env.NODE_ENV = process.env.NODE_ENV || `development`;
            return cmd(args);
        })),
    })
        ...
        builder: (builder) => builder.parserConfiguration({
            "unknown-options-as-args": true,
            "halt-at-non-option": false,
        }),
        handler: handlerP(getCommandHandler(`mcloud`, async (args, cmd) => {
            cmd(args);
            return new Promise((resolve) => { });
        })),
    });
