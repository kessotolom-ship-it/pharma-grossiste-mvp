...
class LocalFileService extends utils_1.AbstractFileProviderService {
    constructor(_, options) {
        ...
        this.getUploadFilePath = (baseDir, fileKey) => {
            ...
            const resolved = path_1.default.resolve(resolvedBase, fileKey);
            const relative = path_1.default.relative(resolvedBase, resolved);
            if (relative === ".." ||
                relative.startsWith(`..${path_1.default.sep}`) ||
                path_1.default.isAbsolute(relative)) {
                throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, `Invalid file key: ${fileKey}`);
            }
            return resolved;
        };
